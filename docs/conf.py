...
sys.path.insert(0, os.path.abspath("../../pynenc_mongo"))

DISTRIBUTION_METADATA = importlib.metadata.metadata("pynenc-mongo")

# -- Project information -----------------------------------------------------
author = "Luis Diaz"
project = "pynenc-mongodb"
...
autodoc2_packages = [{"path": "../pynenc_mongo"}]
...
html_theme = "furo"
html_title = "Pynenc MongoDB Plugin"
...
html_theme_options: dict[str, Any] = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/pynenc/pynenc-mongodb",
            "html": """
    ...
    "source_repository": "https://github.com/pynenc/pynenc-mongodb/",
    "source_branch": "main",
